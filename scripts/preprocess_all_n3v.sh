...
CUDA_VISIBLE_DEVICES='0' python scripts/pre_n3d_colmap.py --videopath $1/coffee_martini_withcam13
CUDA_VISIBLE_DEVICES='0' python scripts/pre_n3d_colmap.py --videopath $1/cook_spinach
CUDA_VISIBLE_DEVICES='0' python scripts/pre_n3d_colmap.py --videopath $1/cut_roasted_beef
